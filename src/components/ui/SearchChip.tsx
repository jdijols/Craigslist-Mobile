...
export function SearchChip({ term, onClear, onEdit }: SearchChipProps) {
  return (
    <div className="flex flex-1 min-w-0 min-w-[80px] h-search-input max-w-full items-center rounded-[--radius-button] bg-white border border-cl-border overflow-hidden">
      <button
        type="button"
        onClick={onEdit}
      ...
      <button
        ...
        className="flex shrink-0 items-center justify-center pl-2.5 pr-2.5 outline-none active:opacity-70 self-stretch"
